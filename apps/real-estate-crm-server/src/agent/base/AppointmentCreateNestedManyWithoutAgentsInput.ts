...
@InputType()
class AppointmentCreateNestedManyWithoutAgentsInput {
...
export { AppointmentCreateNestedManyWithoutAgentsInput as AppointmentCreateNestedManyWithoutAgentsInput };
